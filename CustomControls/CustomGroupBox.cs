...
namespace CustomControls
{
    public class CustomGroupBox : GroupBox
    {
        ...
        private static Point GetPoint = new(0, 0);
        private static string GetName = string.Empty;
        ...
        private void Application_Idle(object? sender, EventArgs e)
        {
            ...
            if (Parent != null)
            {
                ...
                {
                    Control parent = Tools.Controllers.GetTopParent(this);
                    if (parent.Visible)
                    {
                        Debug.WriteLine("Top Parent of " + Name + " is " + parent.Name);
                        parent.Refresh();
                    }
                }
            }
